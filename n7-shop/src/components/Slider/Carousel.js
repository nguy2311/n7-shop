                ...
                <div className="carousel-left">
                    <div className="carousel-left-slide">
                        <Slider asNavFor={nav.nav2}
                            ...
                            <div key={1}>
                                <img
                                    src="https://cdn.cellphones.com.vn/media/ltsoft/promotion/loa-691-301-max.png"></img>
                            </div>
                            <div key={2}>
                            ...
                            <div key={3}>
                                <img
                                    src="https://cdn.cellphones.com.vn/media/ltsoft/promotion/dd690x300_XR.png"></img>
                            </div>
                            <div key={4}>
                                <img src="https://24hstore.vn/images/news/2020/04/13/original/mat-dong-ho-apple-watch-1_1586777356.jpg"></img>
                            </div>
                            <div key={4}>
                                <img
                                    src="https://cdn.cellphones.com.vn/media/ltsoft/promotion/se-aw-690-300-max.png"></img>
                            </div>
                        </Slider>
